      ...
      <Container className="home-section-2">
        <Row className="justify-content-center home-section-2-row">
          <Col md={6} className="home-section-2-col">
            ...
            <div className="desc">
              <p>
              Baba Beard is providing the Blend of 100%  Natural Ingredients, no fillers or Chemical of any
               sort is used in the Premium Quality Beard Oil. We are committed and passionate to provide you the
                Best Beard Oil a man can get to Promotes beard & mustache growth,
